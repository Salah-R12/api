...
final class Version20240101185347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO book (id,title,author, author_id, isbn, published_date, category_id) VALUES (1,'Le Petit Prince',(SELECT name FROM author WHERE name = 'Antoine de Saint-Exupéry'), 1, '978-3-16-148410-0', '1943-04-06', 1);");
    }
