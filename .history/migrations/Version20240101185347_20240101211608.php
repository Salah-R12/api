...
final class Version20240101185347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO author (id, name, bio) VALUES (1, 'Antoine de Saint-Exupéry', 'Biographie de l\'auteur');");
        ...
        $this->addSql("INSERT INTO book (title, author_id, isbn, published_date, publisher_id, category_id) VALUES ('Le Petit Prince', 1, '978-3-16-148410-0', '1943-04-06', 1, 1);");
    }
